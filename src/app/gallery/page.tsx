...
import { Camera, Play, Users, Calendar, Award, Heart, X } from 'lucide-react';
...
export default function GalleryPage() {
  ...
  const categories = [
    ...
    { id: 'classes', name: 'Classes', icon: <Users className="w-4 h-4" /> },
    { id: 'culture', name: 'Korean Culture', icon: <Heart className="w-4 h-4" /> },
